...
#define NX_BCH_HW_EMUL          1
#define	iNX_BCH_VAR_N	NX_BCH_VAR_N
#define	iNX_BCH_VAR_T	NX_BCH_VAR_T

int	NX_NAND_MLC_GetErrorLocation(int *pOddSyn, int *pLocation, int *ErrCnt)
{
	register int i, j;
#if (1 == NX_BCH_HW_EMUL)
...
//		NX_TRACE(("%04X ", reg[i]));
		...
		while( CFALSE == NX_MCUS_IsNFReadEnd() );
