...
#if 0//def CONFIG_CHECK_USB_STORAGE_NUM//bok test
...
{
	printf("Name : %s \n\n", CFG_SYS_BOARD_NAME);//bok test
	printf("Name : %s \n\n", CFG_SYS_BOARD_NAME);
#ifdef CONFIG_CMD_USB
	char *cmd[] = { "usb", "start" };

//bok test	power_valid();

	#if 0//def CFG_PIO_VIBRATION_ENABLE
	{
...
#if 1//(CREATE_3_2INCH_LCD)
//RESET();

DBGOUT("LCD INITIALIZE\n");
mdelay(10);
//EQ setting
...
SPI_PutData(0x1C,0x03);
SPI_PutData(0x19,0x01);
mdelay(5);
SPI_PutData(0x1F,0x90);
mdelay(10);
SPI_PutData(0x1F,0xD4);
mdelay(5);
// Gamma Setting
SPI_PutData(0x40,0x00);
SPI_PutData(0x41,0x29);
SPI_PutData(0x42,0x26);
SPI_PutData(0x43,0x3E);
SPI_PutData(0x44,0x3D);
SPI_PutData(0x45,0x3F);
SPI_PutData(0x46,0x1B);
SPI_PutData(0x47,0x68);
SPI_PutData(0x48,0x04);
SPI_PutData(0x49,0x05);
SPI_PutData(0x4A,0x06);
SPI_PutData(0x4B,0x0C);
SPI_PutData(0x4C,0x17);
SPI_PutData(0x50,0x00);
SPI_PutData(0x51,0x02);
SPI_PutData(0x52,0x01);
SPI_PutData(0x53,0x19);
SPI_PutData(0x54,0x16);
SPI_PutData(0x55,0x3F);
SPI_PutData(0x56,0x17);
SPI_PutData(0x57,0x64);
SPI_PutData(0x58,0x08);
SPI_PutData(0x59,0x13);
SPI_PutData(0x5A,0x19);
SPI_PutData(0x5B,0x1A);
SPI_PutData(0x5C,0x1B);
SPI_PutData(0x5D,0xFF);
// Display ON Setting
SPI_PutData(0x17,0x05);
SPI_PutData(0x16,0x09);
SPI_PutData(0x36,0x00);
...
#endif
#if 0//defined(CONFIG_MACH_SPICA_PB_DTV)

    //  YUV640
    /////////////  YUV640 /////////
    SPI_PutData(0x05, 0x1C);
    SPI_PutData(0x05, 0x5C);

    SPI_PutData(0x00, 0x43);
    SPI_PutData(0x01, 0x90);
    SPI_PutData(0x04, 0x47);    // NTSC input
    SPI_PutData(0x16, 0x00);
    SPI_PutData(0x17, 0x11);
    SPI_PutData(0x18, 0x11);
    SPI_PutData(0x19, 0x00);
    SPI_PutData(0x1A, 0x00);
    SPI_PutData(0x05, 0x5D);

#endif  /* CONFIG_MACH_SPICA_PB_DTV */
}
#endif  /* (CONFIG_MACH_SPICA_PB_DTV) */
