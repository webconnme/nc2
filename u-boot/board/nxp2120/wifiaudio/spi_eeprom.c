...
{
	//	Target Clock ~50MHz ( MX25L6445E Max Read Speed : 50MHz )
	//	Clock Source : PLL1
	//	PLL1 Working Clock : 147.5 MHz or 192 MHz
	//	CLKGEN output : PLL1/3 ( 147.5/3=49.16MHz or 192/3=64MHz )
	pSPIReg->CLKENB = 0x1<<3;	// pclk mode on but not supply operation clock
	pSPIReg->CLKGEN = (3-1)<<5 | 0x1<<2;	// select clock source is pll1 & Devide 3
	pSPIReg->CONT0 =
		...
		(2-1)<< 0;			// CLKGen Clock( Should be greate than 0 )
							//   PLL1(192MHz)  : CLKGEN/2 = 64MHz/2 = 32MHz
							//   PLL1(147.5MHz): CLKGEN/2 = 49.16MHz/2 = 24.58MHz
