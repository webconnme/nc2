...
static void config_usb_bootargs(int boot_device_num)
{
	switch(boot_device_num) {
		case 0:
			setenv("bootargs", "root=/dev/sda1 rw rootwait rootfstype=ext4 console=ttyS0,115200n8 androidboot.hardware=nexell androidboot.console=ttyS0 init=/init raid=noautodetect quiet");
			break;
		case 1:
			setenv("bootargs", "root=/dev/sdb1 rw rootwait rootfstype=ext4 console=ttyS0,115200n8 androidboot.hardware=nexell androidboot.console=ttyS0 init=/init raid=noautodetect quiet");
			break;
	}
}
#endif
