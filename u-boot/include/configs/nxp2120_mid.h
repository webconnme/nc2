 ...
 */
#define CONFIG_PLAT_NXP2120_MID_7INCH
//#define CONFIG_PLAT_NXP2120_MID_8INCH

#if defined (CONFIG_PLAT_NXP2120_MID_7INCH) && defined (CONFIG_PLAT_NXP2120_MID_8INCH)
	#error "Please choose one of 7 inch or 8inch type !!!"
#endif
...
#undef  CFG_SYS_BOARD_NAME
#if defined (CONFIG_PLAT_NXP2120_MID_7INCH)
#define CFG_SYS_BOARD_NAME	"nxp2120-mid-7inch"
#else
#define CFG_SYS_BOARD_NAME	"nxp2120-mid-8inch"
#endif
...
#else
#define CONFIG_BOOTLOGO_COMMAND		"usb read 8ec00000 2000 754; bootlogo 8ec00000"
#endif
#if defined(CONFIG_BOOTLOGO_COMMAND)
#define CONFIG_BOOTLOGO
#endif

#define CONFIG_BOOTCOMMAND				"usb read 81000000 1 15ab; bootm 0x81000000"
...
#if defined (CONFIG_PLAT_NXP2120_MID_7INCH)
//#define CONFIG_BOOTLOGO_COMMAND		NULL
#define CONFIG_BOOTLOGO_COMMAND			"nand read 8ec00000 800000 c0000; bootlogo 8ec00000"	/* must be aligned page size */
#else
#define CONFIG_BOOTLOGO_COMMAND			"nand read 8ec00000 800000 c0000; bootlogo 8ec00000"	/* must be aligned page size */
#endif
#if defined(CONFIG_BOOTLOGO_COMMAND)
...
#define CONFIG_BOOTCOMMAND				"nand read 81000000 0 265a50; nand read 88000000 a00000 25738; bootm 0x81000000"
