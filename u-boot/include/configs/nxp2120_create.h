...
#define CONFIG_BOOTARGS                 "root=/dev/sda1 rw rootwait rootfstype=ext4 console=ttyS0,115200n8 androidboot.hardware=nexell androidboot.console=ttyS0 init=/init raid=noautodetect quiet"
 ...
 * BOOTLOGO
 */
#define CONFIG_BOOTLOGO_COMMAND			"usb read 8ec00000 2000 5dd; bootlogo 8ec00000"
