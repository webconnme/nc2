...
//	ehci->regs = hcd->regs + HC_LENGTH(readl(&ehci->caps->hc_capbase));
	ehci->regs = hcd->regs + HC_LENGTH(ehci, ehci_readl(ehci, &ehci->caps->hc_capbase)); // FALINUX
	
	/* cache this readonly data; minimize chip reads */
//	ehci->hcs_params = readl(&ehci->caps->hcs_params);
	ehci->hcs_params = ehci_readl(ehci, &ehci->caps->hcs_params); // FALINUX
...
static const struct hc_driver ehci_nexell_hc_driver = { // FALINUX
...
//	ehci_port_power(ehci, 1); FALINUX
