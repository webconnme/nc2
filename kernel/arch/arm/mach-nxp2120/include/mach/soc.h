...
int 	soc_alv_get_int_pend(u_int io);
void 	soc_alv_clr_int_pend(u_int io);
...
int 				soc_dma_irq_enable(struct dma_trans *tr, int enable);
...
/* VIDEO */
int 	soc_dpc_set_vid_format(int module, u_int fourcc, int srcw, int srch);
void 	soc_dpc_get_vid_format(int module, u_int *fourcc, int *srcw, int *srch);
void 	soc_dpc_set_vid_address(int module, u_int lu_a, u_int lu_s, u_int cb_a, u_int cb_s,
...
void 	soc_dpc_set_vid_colorkey(int module, u_int color, int enable);
u_int  	soc_dpc_get_vid_colorkey(int module);
void 	soc_dpc_set_vid_color(int module, u_int type, u_int color, int enable);
u_int  	soc_dpc_get_vid_color(int module, u_int type);
void 	soc_dpc_set_vid_hfilter(int module, int enable);
u_int 	soc_dpc_get_vid_hfilter(int module);
void 	soc_dpc_set_vid_vfilter(int module, int enable);
u_int 	soc_dpc_get_vid_vfilter(int module);

int 	soc_dpc_set_vid_configure(int module, u_int fourcc, int srcw, int srch,
								int left, int top, int right, int bottom,
								u_int lu_a, u_int lu_s, u_int cb_a, u_int cb_s,
								u_int cr_a,	u_int cr_s, int waitvsync);
