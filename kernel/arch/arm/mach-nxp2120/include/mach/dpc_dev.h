...
static struct dpc_info dpc_dev[NUMBER_OF_DPC_MODULE] = {
	 {
		...
		.h_fp		= CFG_DISP_PRI_HSYNC_FRONT_PORCH,
		.h_bp		= CFG_DISP_PRI_HSYNC_BACK_PORCH,
		.h_sw		= CFG_DISP_PRI_HSYNC_SYNC_WIDTH,
		.v_fp		= CFG_DISP_PRI_VSYNC_FRONT_PORCH,
		.v_bp		= CFG_DISP_PRI_VSYNC_BACK_PORCH,
